...
((SELECT id FROM diagnosa_sdki WHERE kode_diagnosa='D.0030'), 'Mayor', 'Objektif', 1, 'IMT >27 kg/mÂ² (pada dewasa) atau lebih dari presentil ke 95 untuk usia dan jenis kelamin (pada anak)', 1),
